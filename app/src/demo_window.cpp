...
DemoWindow::DemoWindow(const MongooseVK::WindowParams& params): Window(params)
{
    ...
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::PerformanceWindow(renderer)));
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::CameraSettingsWindow(renderer, &camera, *cameraController)));
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::GridSettingsWindow(renderer)));
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::LightSettingsWindow(renderer)));
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::PostProcessingWindow(renderer)));
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::GBufferViewer(renderer)));
    imGuiVulkan.AddWindow(reinterpret_cast<MongooseVK::ImGuiWindow*>(new MongooseVK::ShadowMapViewer(renderer)));
